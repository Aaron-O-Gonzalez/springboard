# Transaction Streaming and Real-Time Analysis
...
![All_transactions](https://github.com/Aaron-O-Gonzalez/springboard/blob/main/kafka_project/All_transactions.png)
